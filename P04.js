...
// perguntas extraídas do Teste04.js
const questions = [
  {
  ...
  {
    question: "What does it mean if you see a blue smoke coming from your exhaust?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      { answer: "An area covered by your mirrors", correct: false },
      { answer: "An area not covered by your mirrors", correct: true },
      { answer: "A part of the road where the sun dazzles you", correct: false },
      { answer: "A part of the road where the street lights don't work", correct: false }
    ]
  },
  {
    question: "Where would parking your vehicle cause an obstruction?",
    answers: [
      { answer: "Alongside a kerb painted with a single yellow line", correct: false },
      { answer: "In a marked parking space", correct: false },
      { answer: "In front of a property entrance", correct: true },
